#####################################################################
##                                                                 ##
## Script to delete a list of driver packages from ConfigMgr.      ##
...
##                                                                 ##
## Provide a list of driver package names and PackageIDs in a      ##
## CSV format.                                                     ##
##                                                                 ##
...
{
    Write-Host "Processing driver package '$($Package.Name)'" -ForegroundColor Yellow
    Write-Host "  Package ID: $($Package.PackageID)" -ForegroundColor Green
    Try
    {
        $Pkg = Get-CMDriverPackage -Id $Package.PackageID -ErrorAction Stop   
    }
    Catch
    {
    ...
    If ($Pkg)
    {
        ...
        Try
        {
            $Pkg | Remove-CMDriverPackage -Force -ErrorAction Stop
            Write-Host "  Successfully deleted driver package!" -ForegroundColor Green
